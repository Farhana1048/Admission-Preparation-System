		  ...
		  <img src="img/logo.png" alt="" />
		   ...
		   <div class="col-sm-8 my_menu">
		   	...
		   	<ul class="nav navbar-nav  pull-right" >
                 <li><a href="">Home</a></li>
		    	<li class="active"><a href="unit_b.html">online application</a></li>	
	...
	<div class="container">
  	...
  	<div class="row">
  		...
  		<div class="col-md-6 col-offset-3 " id="from">
  			...
  			<center> <b class="registration"> UNIT B </b></center>
  			...
  			<form   name="from" method="post" >
  				...
  				<input type="email" name="b-email" placeholder="Enter your email" class="form-control reg_text"  >
